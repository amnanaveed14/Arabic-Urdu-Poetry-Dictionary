...
public class PatternPLTest {
    ...
    private void start(Stage stage) throws Exception {
        ...
        new PatternPL(facade).show(stage, new Stage());
    }

    @Test
    void should_add_pattern(FxRobot robot) {
        robot.clickOn("Name").write("فعل");
        robot.clickOn("Template").write("{0}{1}{2}");
        robot.clickOn("Add");
    }
}